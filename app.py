...
st.title("Real Estate Navigator📊")
st.markdown("### Built using Lyzr🚀")
st.markdown("The wizard of real estate, making complex decisions simple and stress-free.")
...
if __name__ == "__main__":
    style_app()
    st.sidebar.title("Real Estate Analyzer")
